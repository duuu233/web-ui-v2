...
最新记录：[`history/2026-09/2026-09-02-order-currency-goods-form-layout.md`](history/2026-09/2026-09-02-order-currency-goods-form-layout.md)（订单金额按语种前置币种符号，商品表单改为一行一组语种名称与金额并补充币种文字）。
